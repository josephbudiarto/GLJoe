    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" >
		    <ul class="sidebar-nav">
		        ...
		        <li id="transaction"><a href="transaction.php"><strong><i class="fa fa-line-chart"></i> Transaction Report</strong></a></li>
        ...
        <div class="container-fluid table-responsive" style="padding-top: 70px;">
			<div class="row">
			<h2 style="color:black"><strong>&nbsp &nbsp <i class="fa  fa-plus-square"></i> New Order Detail</strong> <button class="btn btn-primary btn-sm" onclick="window.location='neworder.php'"><i class="fa  fa-arrow-left"></i> Back</button></h2>
					<br>
					<div class="col-md-10 ">
