...
<br><br><Br><br><br>
	...
	<div class="box clearfix">
                            <div class="heading">
                                <h3 class="sty"><strong>Change My Password</strong></h3>
                            </div>
                            <br>
                            <form action="controller/CP_save.php" method="POST">
                ...
                <div class=" col-md-2">
                	<br>
                		...
                		<ul class="nav nav-pills nav-stacked" >
                			...
                			<li class="active"><a href="changepassword.php" style="color:white"><i class="fa fa-lock"></i> Change Password</a></li>
