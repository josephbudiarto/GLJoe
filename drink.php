	...
	<head>
  		...
  		<script>
			...
			function priceFunction(i){
  			...
  			function orderFunction(id){
				...
				xmlhttp.open('GET','controller/cek_order_drink.php?id='+id,true);
		        xmlhttp.send();
			}
		...
		<!--JSON DRINK-->
  		<script type="text/javascript">
			...
			var url = "controller/drink_json.php";
			...
			function myFunction(response) {
			    ...
			    for(i = 0; i < arr.length; i++) {
			    	out += "<div class='col-sm-4'><div class='thumbnail'><img src='images/"+ arr[i].image +"' alt='"+ arr[i].nama +"' style='width:400px;height:270px;'><div class=''><h3 align='center'>"+ arr[i].nama +"</h3><p align='center'><strong>Large : Rp "+ arr[i].harga +",-</strong><br><br><a onclick='orderFunction("+ arr[i].other_id +")' data-toggle='modal' data-target='#myModalUkuran' class='btn btn-warning btn-sm' role='button'><span class='glyphicon glyphicon-shopping-cart'></span>  PESAN</a></p></div><div class='jumbotron' align='center' style='background-color:white; margin-top:0px;padding-top:0px;padding-bottom:0px;'></div></div></div>"
				}
			    document.getElementById("drink_result").innerHTML = out;
			}
  		</script>
	</head>
	<body class="relative">
