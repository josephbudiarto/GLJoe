	...
	<head>
  		...
  		<script>
			...
			function priceFunction(i){
  			...
  			function orderFunction(id){
		        ...
		        xmlhttp.open('GET','controller/cek_order_pasta.php?id='+id,true);
		        xmlhttp.send();
			}
		...
		<!--JSON DRINK-->
  		<script type="text/javascript">
			...
			var url = "controller/pasta_json.php";
			...
			function myFunction(response) {
			    ...
			    document.getElementById("pasta_result").innerHTML = out;
			}
  		</script>
	</head>
	<body class="relative">
